...
<body>
  <a href="Withdrawal.php" > <span class="material-symbols-outlined">
   ...
   <center> <h1>Withdrawing from Venmo <img src="resource/venmo.png" width="60em" height="40em" style="position:absolute;margin-top: -0.1em;margin-left: 0.3em;"> </h1></center>

   <center> <div class="Formcontainer">
        <form class="form" action="pinval.php" method="post">
           <input type="email" name="email" id="email" class="formelement" placeholder="Input your Venmo email address"><br>
